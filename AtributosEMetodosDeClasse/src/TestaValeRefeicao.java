...
public class TestaValeRefeicao {
	...
	public static void main(String[] args) {
		...
		System.out.println("Digite o Valor do Vale Refeição"); // usar vírgula 
		...
		System.out.println("Digite a Taxa de Aumento do Vale Refeição"); // usar vírgula 
		...
		System.out.println("Novo valor do Vale Refeição..: R$ " + decimalFormat.format(Funcionario.valorVr));
		*/
		
		System.out.println("Novo valor do Vale Refeição..: R$ " + Funcionario.valorVr);
